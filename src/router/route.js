...
const {createstudent,updatestudent,geStudentByquery,DeletedStudent}= require("../controller/studentscontroller")
...
router.delete("/user/DeletedStudent/:studentid",authentication,DeletedStudent)
